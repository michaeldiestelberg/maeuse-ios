...
Investigated September 15, 2026 against Mäuse build 44 (`11e0c3c`), Apple's current documentation, and the installed Xcode 27.0 (27A266a) SDK. This records the initial design and feasibility review. A subsequent prototype is documented in [implementation and access status](apple-voice-implementation.md); it is not released.
