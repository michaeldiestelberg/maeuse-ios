...
- [x] Marketing version bumped to `1.3.1`; repository build number bumped to `39`.
...
- [x] Xcode Cloud Next Build Number confirmed as `39` and repository aligned before the final push (September 13, 2026).
