...
- [x] Xcode Cloud workflow updated from the retired Xcode 27 RC environment to final Xcode 27 (27A266a); build 45 failed before compilation, and the next Cloud build is 46.
- [x] Recovery UI and English/German localization parity verified.
- [ ] Release commit pushed to `main`; **Maeuse | Default** succeeds.
- [ ] Build `1.3.1 (46)` is processed and distributed to the internal Family group.
...
Evidence and scope: `Review/1.3.1-review-fixes.md`. Historical build 44 results below do not substitute for a fresh build 46 iOS 27 or hardware pass.
...
- [ ] Confirm Xcode Cloud assigns build `42`, matching the repository.
...
- [x] Static Save label, subtitle removal, and total-only footer compile without warnings and are verified in a German simulator screenshot (September 14, 2026).
...
Version 1.3.0 (32) remains the public App Store release. The checklist below preserves the earlier App Store submission record; this release is for internal TestFlight testing.

## Earlier 1.3.0 Submission Checklist
