...
```sh
scripts/bump-version.sh build  # 1.3.0 (27) -> 1.3.0 (28)
scripts/bump-version.sh patch  # 1.3.0 (27) -> 1.3.1 (28)
scripts/bump-version.sh minor  # 1.3.0 (27) -> 1.4.0 (28)
scripts/bump-version.sh major  # 1.3.0 (27) -> 2.0.0 (28)
```
