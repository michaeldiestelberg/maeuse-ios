...
```sh
scripts/bump-version.sh build  # 1.3.0 (32) -> 1.3.0 (33)
scripts/bump-version.sh patch  # 1.3.0 (32) -> 1.3.1 (33)
scripts/bump-version.sh minor  # 1.3.0 (32) -> 1.4.0 (33)
scripts/bump-version.sh major  # 1.3.0 (32) -> 2.0.0 (33)
```
