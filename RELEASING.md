...
App Store live: **1.3.0 (31)**. Version `1.2.1` shipped only to TestFlight and is superseded by `1.3.0`.
...
```sh
scripts/bump-version.sh build  # 1.3.0 (31) -> 1.3.0 (32)
scripts/bump-version.sh patch  # 1.3.0 (31) -> 1.3.1 (32)
scripts/bump-version.sh minor  # 1.3.0 (31) -> 1.4.0 (32)
scripts/bump-version.sh major  # 1.3.0 (31) -> 2.0.0 (32)
```
